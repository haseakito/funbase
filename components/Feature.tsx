        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">We plan best fit marketing strategy for you. Collaborate seamlessly with your fun and achieve your marketing goals every month.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Protect your work and stay legitimately compliant with your local regulations and make your work risk free to enjoy.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Start free and generate revenue while we handle the critical financial operations like month-end close and quarterly budgeting.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Scheduling your activities and collecting customer voices. Answer just a few questions and power up your workflows with us.</p>
                </div>
            </div>
        </div>
    )
